      ...
      <div className="min-h-0 flex-1 space-y-3 overflow-y-auto overscroll-contain pr-1">
        {online.map((d) => (
          <Link
            ...
            key={d.id}
            className="flex items-center gap-3 rounded-2xl bg-white/[.04] p-3 transition-colors hover:bg-white/[0.07] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-emerald-400/80"
          >
